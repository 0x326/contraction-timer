...
export const PrimaryControl: React.FC<Props> = ({ type, onClick, disabled = false }) => {
  ...
  return (
    <StyledPrimaryControl type="button" aria-label={label} status={status} disabled={disabled} onClick={onClick}>
